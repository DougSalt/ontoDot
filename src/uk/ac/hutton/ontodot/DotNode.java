...
public class DotNode extends AbstractNode implements PropertyValueNode {
   ...
   * 
   * @param row A row of text to add
   */
   ...
   * <!-- setPropertyValue -->
   *
   * @see uk.ac.hutton.ontodot.PropertyValueNode#setPropertyValue(java.lang.String, java.lang.String)
   * @param property
   * @param value
   */
   ...
   * <!-- setPropertyValues -->
   *
   * @see uk.ac.hutton.ontodot.PropertyValueNode#setPropertyValues(java.lang.String, java.lang.String[])
   * @param property
   * @param values
   */
  ...
  public void write(PrintWriter fp) throws IOException {
    ...
    if(textStr != null && attributes.containsKey("shape") && getAttributeValue("shape").endsWith("record")) {
      try {
